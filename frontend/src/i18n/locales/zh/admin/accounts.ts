export default {
    accounts: {
      ...
      openai: {
        ...
        codex429Guard: '卡429（奸商模式）',
        codex429GuardHint: '默认关闭。仅 OpenAI/Codex OAuth 账号可用；开启后在普通请求历史末尾追加一对合成工具调用与响应，配额耗尽（429）后仍可能继续出量，同时首次 429 不再立即冷却账号（30 秒内两次 429 才冷却）。可能影响客户体验并提高上游风控/封号风险，请按账号单独评估。CC/Claude 渠道不受影响。',
        codex429GuardApply: '在导入的 OpenAI OAuth 账号上启用',
