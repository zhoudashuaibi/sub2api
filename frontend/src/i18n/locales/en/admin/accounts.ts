export default {
    accounts: {
      ...
      openai: {
        ...
        codex429Guard: '429 Overdraft Guard',
        codex429GuardHint: 'Off by default. OpenAI/Codex OAuth accounts only. When enabled, a paired synthetic tool call and response is appended to the tail of ordinary request histories so an exhausted account may keep serving after 429; the first 429 no longer cools the account down immediately (two 429s within 30s are required). This can affect client experience and raises upstream risk-control/ban risk - evaluate per account. CC/Claude channels are unaffected.',
        codex429GuardApply: 'Apply to imported OpenAI OAuth accounts',
